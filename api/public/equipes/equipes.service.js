...
let EquipesService = class EquipesService {
    constructor(equipeRepository) {
    ...
    async update(id, updateEquipeDto) {
        ...
        if (!equipe) {
            throw new common_1.NotFoundException(`Equipe with ID ${id} not found`);
        }
...
exports.EquipesService = EquipesService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(equipe_entity_1.Equipe)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], EquipesService);
//# sourceMappingURL=equipes.service.js.map